...
export default function Sortby() {
  const [Sortbygame, setSortbygame] = useState([])
  // const [loading, setLoading] = useState(null)
  let parm = useParams()

  async function getSortbyGames(typ) {
  ...
  useEffect(() => {
    getSortbyGames(parm.type)
  }, []);



  return <>
    {Sortbygame.length !== 0 ? <div className="container">
        <div className="row m-3">
          {Sortbygame.slice(0, 20).map((game, index) =>
